...
namespace particle
{
    ...
    public:
        ...
        auto begin() noexcept { return blocks_; }
        auto end() noexcept { return blocks_ + numBlocks_; }

        auto begin() const noexcept { return blocks_; }
        auto end() const noexcept { return blocks_ + numBlocks_; }
